defmodule Lanttern.MessageBoardV2Test do
  ...
  describe "messages" do
    ...
    test "get_message/2 with school_id opt returns message when it belongs to the school" do
      school = insert(:school)
      section = insert(:section, school: school)
    ...
    test "get_message/2 with school_id opt returns nil when message doesn't belong to school" do
      school1 = insert(:school)
      school2 = insert(:school)
      section1 = insert(:section, school: school1)
    ...
    test "get_message/2 with school_id opt returns nil when message doesn't exist" do
      school = insert(:school)
