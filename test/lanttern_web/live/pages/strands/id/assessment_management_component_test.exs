defmodule LantternWeb.StrandLive.AssessmentManagementComponentTest do
  ...
  describe "display" do
    test "shows assessment info when present", %{conn: conn} do
      ...
      conn
      |> visit("#{@live_view_base_path}/#{strand.id}/assessment_management")
  ...
  describe "reorder assessment points" do
    test "reorder assessment points within the same moment", %{conn: conn} do
      ...
      {:ok, view, _html} = live(conn, "/strands/#{strand.id}/assessment_management")
