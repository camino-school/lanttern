defmodule LantternWeb.StudentReportCardsLiveTest do
  use LantternWeb.ConnCase

  alias Lanttern.ReportingFixtures
  alias Lanttern.SchoolsFixtures

  @live_view_path "/student_report_cards"

  setup [:register_and_log_in_guardian]

  describe "Student report cards view basic navigation" do
    ...
    test "list student report cards", %{conn: conn, user: user, student: student} do
      ...
      assert_redirect(view, "/student_report_cards/#{student_report_card.id}")
    end
  end
end
