defmodule Lanttern.Identity.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Lanttern.Repo)
  ...
  """
  def valid_password?(%Lanttern.Identity.User{hashed_password: hashed_password}, password)
