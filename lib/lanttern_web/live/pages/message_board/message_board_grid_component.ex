defmodule LantternWeb.MessageBoard.MessageBoardGridComponent do
  ...
  Updated layout with mobile carousel and desktop grid.
  """
    ...
    <div class="space-y-8">
      ...
      <%= for section <- @sections do %>
        <div class="space-y-4 px-0">
          <div>
            <h3 class="text-lg font-bold mb-1 pl-6 md:pl-0">
              {section.name}
            </h3>
          </div>
              ...
              >
                ...
                <%= for message <- section.messages do %>
                  <div
                    ...
                    class="snap-center flex-shrink-0 w-[80vw] max-w-[300px] scroll-smooth"
                    style="overflow: visible;"
                  >
                    <div class="mt-1 mb-9">
