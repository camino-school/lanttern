defmodule LantternWeb.StudentsRecords.StudentRecordTagFormOverlayComponent do
  @moduledoc """
  Renders an overlay with a `StudentsRecords.Tag` form
  ...
  defp assign_form(socket) do
    ...
    changeset = StudentsRecords.change_student_record_tag(tag)
  ...
  def handle_event("delete", _, socket) do
    StudentsRecords.delete_student_record_tag(socket.assigns.tag)
    |> case do
      {:ok, tag} ->
  ...
  defp assign_validated_form(socket, params) do
    ...
    changeset =
      socket.assigns.tag
      |> StudentsRecords.change_student_record_tag(params)
  ...
  defp save_tag(socket, nil, tag_params) do
    StudentsRecords.create_student_record_tag(tag_params)
    |> case do
      {:ok, tag} ->
  ...
  defp save_tag(socket, _id, tag_params) do
    StudentsRecords.update_student_record_tag(
      socket.assigns.tag,
      tag_params
    )
    |> case do
