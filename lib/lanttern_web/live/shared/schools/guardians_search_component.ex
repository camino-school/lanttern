defmodule LantternWeb.Schools.GuardiansSearchComponent do
  @moduledoc """
  Renders a `Guardian` search component
  """
    ...
    <div class={@class}>
      ...
      <div class="relative">
        <.base_input
          ...
          role="combobox"
          autocomplete="off"
          aria-controls="guardian-search-controls"
          aria-expanded="false"
